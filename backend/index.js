...
mongoose.connect("mongodb+srv://pratham9272:9272673893@cluster0.1nus8.mongodb.net/amazonclone")
...
app.post('/addproduct', async (req, res) => {
  try {
    ...
    if (products.length > 0) {
      let last_product = products[products.length - 1]; // Access last product directly
      id = last_product.id + 1; // Increment last product ID by 1
    } else {
      id = 1; // First product
    }
